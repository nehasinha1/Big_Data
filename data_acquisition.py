...
#    print "%%%%%%%%%%%%%%%%%% in path exists or not"
    ...
    if os.stat("wikimovies2010_2015.txt").st_size==0:
        urls = ["http://en.wikipedia.org/wiki/List_of_American_films_of_2000",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2001",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2002",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2003",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2004",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2005",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2006",
		"http://en.wikipedia.org/wiki/List_of_American_films_of_2007",
